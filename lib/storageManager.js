	...
	.then(files=>
	{
		...
		files=files.map(function(file)
		{
			...
			.then(function(result)
			{
				...
				{
					var errors=result.others.map(other=>({error:worker.errorSerializer(other.error),file:other.file.getAbsolutePath()}));
			...
			function(errors)
			{
				errors=errors.map(other=>({error:worker.errorSerializer(other.error),file:other.file.getAbsolutePath()}));
